...
import com.open.iot.model.system.constants.UserType;
import com.open.iot.modelandutils.base.Result;
import com.open.iot.ucpm.dao.SysUserDao;
...
import com.open.iot.utils.ValidatorUtil;
...
public class SysUserServiceImpl implements SysUserService {
	...
	@Override
	public PageInfo findUsers(Map<String, Object> params) {
		...
		PageInfo pageInfo = new PageInfo<>(list == null?Collections.emptyList():list);
		return pageInfo;
	}
